...
export const ActiveChatterFormStep: React.FC<{
    ...
    <Stack>
      ...
      >
        <Box>
          ...
          <Text size="sm" mb={'sm'}>
            Minimum amount of time a user must be active in chat to be eligible
          </Text>
        </Box>
        <Combobox
          store={combobox}
          ...
          <Combobox.Target>
            ...
            >
              {selectedOption?.label || (
                <Input.Placeholder>Pick a time</Input.Placeholder>
              )}
            </InputBase>
          </Combobox.Target>
