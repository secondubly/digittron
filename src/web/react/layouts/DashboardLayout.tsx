...
export function DashboardLayout({ children }) {
    ...
    const isBlankPage = location.pathname.startsWith('/overlay')

    return (
        <AppShell
            header={{ height: 60, collapsed: (isBlankPage || isMediumScreenOrLarger) }}
            navbar={{
                width: { desktop: 'fit-content', mobile: '100%' },
                breakpoint: 'sm', // switch to mobile below this breakpoint
                collapsed: { mobile: !opened, desktop: isBlankPage },
