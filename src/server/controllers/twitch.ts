...
//     const tokensTable = em.getRepository(OauthToken)

//     const token = await tokensTable.findOne(Number(id))

//     if (!token || !token.access_token_encrypted) {
//         return null
//     }
...
//             await server.tokenStore.set(
//                 `twitch:${config.TWITCH_BROADCASTER_ID}`,
//                 tokenData,
//             )
//             // request.em.upsert(Token, {
